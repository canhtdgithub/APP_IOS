...
class SettingViewController: UIViewController {
    ...
    @IBAction func reminder(_ sender: UIButton) {
        ModelSetting.shared.testReminder(tick: tick, contrainstTable: contrainstTable)
    }
    ...
    override func viewDidLoad() {
        ...
        ModelSetting.shared.testShowReminder(tick: tick, contrainstTable: contrainstTable)
